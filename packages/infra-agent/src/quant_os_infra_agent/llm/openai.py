...
class OpenAIProvider(BaseLLMProvider):
    ...
    def __init__(
        ...
        self._provider_name = provider_label
        super().__init__(api_key, base_url, default_model or "gpt-4o")
    ...
    def default_model(self) -> str:
        return self._default_model or "gpt-4o"
    ...
    async def chat_stream(
        ...
        try:
            ...
            from quant_os_shared.errors import LLMError
            raise LLMError(f"OpenAI stream request failed: {e}") from e
